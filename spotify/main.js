...
var bot = new SlackBot({
    token: 'xoxb-192138820706-XyO2wDYD0YPE4OHEPykBvYJ8', // Add a bot https://my.slack.com/services/new/bot and put the token  
    name: 'BAMusic'
});
...
playSong = function(artist,song){
    console.log("inside playsong "+ artist +" "+ song)
